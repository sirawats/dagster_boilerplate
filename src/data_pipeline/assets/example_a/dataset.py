import pandas as pd
from dagster import MetadataValue, OpExecutionContext, asset, StaticPartitionsDefinition
...
def dataset(context: OpExecutionContext) -> pd.DataFrame:
    p_key = context.asset_partition_key_for_output()
    pois = [
